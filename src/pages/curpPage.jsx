  ...
  <div className="containerform">
    <form className="form" onSubmit={handleSubmit}>
      <div className="titleWithImage">
        <p className="title">Sistema Curp Chiapas</p>
        <img
          src="https://seeklogo.com/images/G/Gobierno_de_Chiapas-logo-7684BFF3C9-seeklogo.com.png"
          className="logo"
        />
      </div>
            <div>
        ...
        <div className="info"  style={{display: curp ? "block" : "none"}}>
          {curp && (
            <div className="curp">
              <p>Datos del registro de la Curp:</p>
              <p>Nombre(s): {nombre}</p>
